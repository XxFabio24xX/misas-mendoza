-- Add recibe_caritas to lugares (safe no-op if already added manually)
ALTER TABLE public.lugares ADD COLUMN IF NOT EXISTS recibe_caritas BOOLEAN DEFAULT false;

-- Update crear_lugar RPC to accept recibe_caritas
...
BEGIN
  ...
  INSERT INTO public.lugares (
    ...
    descripcion, imagen_url, hay_confesiones, activo, notas_horarios, recibe_caritas
  ) VALUES (
    ...
    p_descripcion, p_imagen_url, p_hay_confesiones, p_activo, p_notas_horarios, p_recibe_caritas
...
-- Update actualizar_lugar RPC to accept recibe_caritas
